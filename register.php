									...
									<br><br>
										...
										<table>
											<form action="process_register.php" method="POST">
												...
												<tr>
													<td><b>Gender:</b>&nbsp;&nbsp;</td>
													<td><input type="radio" style="width: 50px;height: 15px;" value="Male" name="gender" id='m'><label> Male</label>
														<input type="radio" style="width: 50px;height: 15px;" value="Female" name="gender" width="20" height="15	" id='f'><label>Female</label></td>
