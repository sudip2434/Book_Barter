<?php session_start();
	...
	$aq = "SELECT * FROM user WHERE u_id =(SELECT u_id FROM book WHERE b_id=$id)";
	$cq = mysqli_query($conn,$aq) or die("Can't Execute Query..");
									...
									<div class="entry">
										<?php
											...
											<table border="0" width="100%">
												 ...
												 if(isset($_SESSION['status']))
												 {
													echo '
														<tr>
																...
																<td align="left">'.$c['u_unm'].'</td>
														</tr>
														<tr>
																<td align="right">Contact number:</td>
																
																<td align="left">'.$c['u_contact'].'</td>
												...
												{
													echo '<td><h4>Login to see contact number</h4><br><a href="register.php"> <h4>Please Login..</h4></a></td>';
												}
												echo '</tr>
											</table>';
										?>
